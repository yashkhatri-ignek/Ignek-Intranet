<nav aria-label="<@liferay.language key="site-pages" />" class="${nav_css_class}" id="navigation" role="navigation">
    <ul class="sidebar-menu" role="menubar">
        <#list nav_items as nav_item>
            ...
            <li class="${nav_item_css_class} sidebar-menu-item" id="layout_${nav_item.getLayoutId()}" role="presentation">
                <a ${nav_item_attr_has_popup} class="active" href="${nav_item.getURL()}" ${nav_item.getTarget()} role="menuitem">
