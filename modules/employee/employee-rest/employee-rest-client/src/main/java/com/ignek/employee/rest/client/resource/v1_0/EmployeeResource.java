package com.ignek.employee.rest.client.resource.v1_0;
...
import com.ignek.employee.rest.client.problem.Problem;
...
public interface EmployeeResource {
	...
	public HttpInvoker.HttpResponse postEmployeeHttpResponse(Employee employee)
		throws Exception;

	public void postEmployeeBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postEmployeeBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putEmployeeBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;
	...
	public static class EmployeeResourceImpl implements EmployeeResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/employee-rest/v1.0/employees/{employeeId}");

			httpInvoker.path("employeeId", employeeId);
		...
		public void deleteEmployeeBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteEmployeeBatchHttpResponse(callbackURL, object);
		...
		public HttpInvoker.HttpResponse deleteEmployeeBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/employee-rest/v1.0/employees/batch");
		...
		public HttpInvoker.HttpResponse getEmployeesHttpResponse()
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/employee-rest/v1.0/employees");
		...
		public Employee postEmployee(Employee employee) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postEmployeeHttpResponse(
				employee);
		...
		public HttpInvoker.HttpResponse postEmployeeHttpResponse(
				Employee employee)
			throws Exception {
		...
		public void postEmployeeBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				postEmployeeBatchHttpResponse(callbackURL, object);
		...
		public void putEmployeeBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				putEmployeeBatchHttpResponse(callbackURL, object);
