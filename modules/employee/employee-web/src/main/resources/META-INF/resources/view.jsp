...
<%
    ...
    boolean isHRorAdmin = GetterUtil.getBoolean(request.getAttribute("isHRorAdmin"));
%>
...
<div class="employee-list">
    ...
    <div class="employee-table">
        ...
        <liferay-ui:search-container  total="${total}" delta="2" emptyResultsMessage="no-entries-found" >
            ...
            <liferay-ui:search-container-row className="com.ignek.employee.model.Employee" modelVar="employee" indexVar="rowIndex">
                ...
                <portlet:resourceURL id="/employee/download/pdf" var="downloadPDFURL">
                    <portlet:param name="employeeId" value="${employee.employeeId}" />
                </portlet:resourceURL>
                ...
                <liferay-ui:search-container-column-text name="City"
                    ...
                    <liferay-ui:search-container-column-text name="Action">
                        ...
                        <% } %>
                         ...
                         <a href="<%=downloadPDFURL%>" class="download-link">
